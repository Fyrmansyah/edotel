    ...
    <div class="offcanvas max-w-[1300px] transition-all">
        <div class="flex w-[100%] flex-col">
            <div class="rts__btstrp__offcanvase relative max-w-[1300px]">
                <div
                    class="offcanvase__wrapper flex items-center md:bg-transparent lg:bg-[#2b2b2b]"
                >
                    <div
                            ...
                            <div class="flex flex-col gap-[15px]">
                                <div class="flex flex-col gap-[5px] text-white">
                                    ...
                                    <a href="tel:+1234567890"
                                        ><i class="flaticon-phone-flip"></i> +1234567890</a
                                    >
                                </div>
                                <div class="flex flex-col gap-[5px] text-white">
                                    <span class="h6">Email</span>
                                    <a class="flex items-center gap-2" href="mailto:info@hostie.com"
                                        ><i class="flaticon-envelope relative top-1"></i
                                        >info@hostie.com</a
                                    >
                                </div>
                                <div class="flex flex-col gap-[5px] text-white">
                                    ...
                                    <a href="#"
                                        ><i class="flaticon-marker"></i> 280 Augusta Avenue, M5T 2L9
                                        Toronto, Canada</a
                                    >
                                </div>
                            </div>
                            ...
                            <nav class="desktop__menu offcanvas__menu">
                                <ul class="m-0 list-none p-0">
                                    <li class="slide has__children">
                                        <a class="slide__menu__item" href="#"
                                            >Home
                                    ...
                                    <li class="slide">
                                        <a class="slide__menu__item" href="about.html">About us </a>
                                    </li>
                                    <li class="slide has__children">
                                        <a class="slide__menu__item" href="#"
                                            >Rooms
                                        ...
                                        <ul class="slide__menu">
                                            ...
                                            <li>
                                                <a href="room-details-2.html">Room Details Two</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="slide has__children">
                                    ...
                                    <li class="slide has__children">
                                        <a class="slide__menu__item" href="contact.html"
                                            >Contact Us
                                        </a>
                                    </li>
                                </ul>
